...
python3 ./build/fbcode_builder/getdeps.py --allow-system-packages --scratch-path "${SCRATCH_PATH}" build --extra-cmake-defines='{"DCMAKE_LIBRARY_ARCHITECTURE":"arm64", "CMAKE_CXX_FLAGS":"-fcoroutines-ts"}'
cd ..
